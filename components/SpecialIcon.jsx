...
const HomeIconEmpty = ({ className, ...props }) => (
	<svg
		viewBox='0 0 24 24'
		className={`fill-current stroke-current stroke-0 ${className}`}
		{...props}
...
const SearchIconEmpty = ({ className, ...props }) => (
	<svg
		viewBox='0 0 24 24'
		className={`fill-current stroke-current stroke-0 ${className}`}
		{...props}
...
const BellIconEmpty = ({ className, ...props }) => (
	<svg
		viewBox='0 0 24 24'
		className={`fill-current stroke-current stroke-0 ${className}`}
		{...props}
...
const MailboxIcon = ({ className, ...props }) => (
	<svg
		viewBox='0 0 24 24'
		className={`fill-current stroke-current stroke-0 ${className}`}
		{...props}
...
const MailboxIconEmpty = ({ className, ...props }) => (
	<svg
		viewBox='0 0 24 24'
		className={`fill-current stroke-current stroke-0 ${className}`}
		{...props}
